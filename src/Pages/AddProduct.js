...
import addProductData from '../Redux/Middleware/addProductData';
        ...
        <div className='flex justify-center items-center h-full '>
            ...
            >
                <div className='flex flex-col w-full max-w-xs'>
                    ...
                    <input className='border' type='text' id='model' {...register("model")} />
                </div>
                <div className='flex flex-col w-full max-w-xs'>
                    <label className='mb-2' htmlFor='image'>
                        Image
                    </label>
                    <input type='text' className='border' name='image' id='image' {...register("image")} />
                </div>
                ...
                <div className='flex flex-col w-full max-w-xs'>
                    ...
                    <select name='brand' className='border' id='brand' {...register("brand")}>
                ...
                <div className='flex flex-col w-full max-w-xs'>
                    ...
                    <input type='text' className='border' name='price' id='price' {...register("price")} />
                </div>
